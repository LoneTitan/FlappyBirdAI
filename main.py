...
class Bird:
    IMG = BIRD_IMG
    MAX_ROTATION = 25  # Max rotation while going up
    ROT_VEL = 20  # How much we will rotate
    ANIMATION_TIME = 5
    ...
    def move(self):
        ...
        d = self.vel * self.tick_count + 1.5 * self.tick_count ** 2  # s = ut + 0.5*a*t^2
